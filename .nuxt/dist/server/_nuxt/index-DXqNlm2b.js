...
import { u as useNotification, T as TaskForm } from "./TaskForm-BRq13ooQ.js";
...
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "progress-bar-wrapper" }, _attrs))} data-v-985281e9>`);
      if (__props.label) {
        _push(`<div class="label" data-v-985281e9>${ssrInterpolate(__props.label)} `);
        if (__props.showPercent) {
          _push(`<span data-v-985281e9>${ssrInterpolate(percent.value)}%</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(`<div class="progress-bar" style="${ssrRenderStyle({ height: __props.height })}" data-v-985281e9><div class="progress-fill" style="${ssrRenderStyle({ width: percent.value + "%" })}" data-v-985281e9></div></div></div>`);
    };
  }
});
...
const ProgressBar = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-985281e9"]]);
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "stats-bar" }, _attrs))} data-v-752ebd92><div class="stat-block level-block" data-v-752ebd92><div class="stat-row" data-v-752ebd92>`);
      _push(ssrRenderComponent(unref(Zap), {
        size: 18,
        class: "stat-icon"
      }, null, _parent));
      _push(`<span class="stat-label" data-v-752ebd92>Ур. ${ssrInterpolate(unref(userStore).level)}</span><span class="stat-value" data-v-752ebd92>${ssrInterpolate(unref(userStore).currentXP)}/${ssrInterpolate(unref(userStore).neededXPForNextLevel)}</span></div>`);
      ...
      _push(`</div><div class="stat-block league-block" data-v-752ebd92><div class="stat-row" data-v-752ebd92>`);
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(leagueIcon.value), {
        size: 18,
        class: ["stat-icon", leagueClass.value]
      }, null), _parent);
      _push(`<span class="stat-label" data-v-752ebd92>${ssrInterpolate(unref(userStore).league)}</span><span class="stat-value" data-v-752ebd92>${ssrInterpolate(nextLeagueProgress.value)}%</span></div><div class="league-progress" data-v-752ebd92><div class="league-progress-fill" style="${ssrRenderStyle({ width: nextLeagueProgress.value + "%" })}" data-v-752ebd92></div></div></div><div class="stat-block coins-block" data-v-752ebd92><div class="stat-row" data-v-752ebd92>`);
      _push(ssrRenderComponent(unref(Coins), {
        size: 18,
        class: "stat-icon"
      }, null, _parent));
      _push(`<span class="stat-label" data-v-752ebd92>Монеты</span><span class="stat-value" data-v-752ebd92>${ssrInterpolate(unref(userStore).coins)}</span></div></div><div class="stat-block tasks-block" data-v-752ebd92><div class="tasks-indicators" data-v-752ebd92><div class="${ssrRenderClass([{ done: completedTasks.value.day === 3 }, "task-indicator"])}" data-v-752ebd92><span class="task-label" data-v-752ebd92>Д</span><span class="task-count" data-v-752ebd92>${ssrInterpolate(completedTasks.value.day)}/3</span></div><div class="${ssrRenderClass([{ done: completedTasks.value.week === 3 }, "task-indicator"])}" data-v-752ebd92><span class="task-label" data-v-752ebd92>Н</span><span class="task-count" data-v-752ebd92>${ssrInterpolate(completedTasks.value.week)}/3</span></div><div class="${ssrRenderClass([{ done: completedTasks.value.month === 3 }, "task-indicator"])}" data-v-752ebd92><span class="task-label" data-v-752ebd92>М</span><span class="task-count" data-v-752ebd92>${ssrInterpolate(completedTasks.value.month)}/3</span></div><div class="${ssrRenderClass([{ done: completedTasks.value.year === 3 }, "task-indicator"])}" data-v-752ebd92><span class="task-label" data-v-752ebd92>Г</span><span class="task-count" data-v-752ebd92>${ssrInterpolate(completedTasks.value.year)}/3</span></div></div></div></div>`);
    };
  }
});
...
const StatsOverview = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-752ebd92"]]);
...
const GlassCard = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-968c65f4"]]);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(GlassCard, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="node-main" data-v-1d9a0abf${_scopeId}><div class="node-header" data-v-1d9a0abf${_scopeId}>`);
            ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(iconComponent.value), { size: 20 }, null), _parent2, _scopeId);
            _push2(`<div class="header-actions" data-v-1d9a0abf${_scopeId}><button class="edit-btn" data-v-1d9a0abf${_scopeId}>`);
            _push2(ssrRenderComponent(unref(PenSquare), { size: 14 }, null, _parent2, _scopeId));
            _push2(`</button><span class="${ssrRenderClass([unref(milestone).status, "status-dot"])}" data-v-1d9a0abf${_scopeId}></span></div></div><h4 data-v-1d9a0abf${_scopeId}>${ssrInterpolate(unref(milestone).name)}</h4>`);
            ...
            _push2(`<div class="xp-info" data-v-1d9a0abf${_scopeId}>${ssrInterpolate(unref(milestone).currentXP)} / ${ssrInterpolate(unref(milestone).requiredXP)} XP </div><button class="expand-btn" data-v-1d9a0abf${_scopeId}>`);
            ...
            _push2(`</button></div>`);
            if (isExpanded.value) {
              _push2(`<div class="node-details" data-v-1d9a0abf${_scopeId}>`);
              if (unref(milestone).description) {
                _push2(`<p data-v-1d9a0abf${_scopeId}>${ssrInterpolate(unref(milestone).description)}</p>`);
              } else {
                _push2(`<p class="placeholder" data-v-1d9a0abf${_scopeId}>Нет описания</p>`);
              }
              _push2(`<div class="linked-tasks" data-v-1d9a0abf${_scopeId}><span class="label" data-v-1d9a0abf${_scopeId}>Привязанные задачи:</span>`);
              if (linkedTasks.value.length) {
                _push2(`<ul data-v-1d9a0abf${_scopeId}><!--[-->`);
                ssrRenderList(linkedTasks.value, (task) => {
                  _push2(`<li data-v-1d9a0abf${_scopeId}>${ssrInterpolate(task.title)}</li>`);
                });
                _push2(`<!--]--></ul>`);
              } else {
                _push2(`<span class="empty" data-v-1d9a0abf${_scopeId}>Нет задач</span>`);
              }
              _push2(`</div></div>`);
            } else {
              _push2(`<!---->`);
...
const BranchNode = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-1d9a0abf"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        _push2(`<div class="modal-overlay" data-v-680aee3a><div class="modal" data-v-680aee3a><div class="modal-header" data-v-680aee3a><h3 data-v-680aee3a>Редактировать этап</h3><button class="close-btn" data-v-680aee3a>`);
        _push2(ssrRenderComponent(unref(X), { size: 20 }, null, _parent));
        _push2(`</button></div><form data-v-680aee3a><div class="form-group" data-v-680aee3a><label data-v-680aee3a>Название</label><input${ssrRenderAttr("value", form.name)} type="text" required data-v-680aee3a></div><div class="form-group" data-v-680aee3a><label data-v-680aee3a>Описание</label><textarea placeholder="Краткое описание этапа..." rows="2" data-v-680aee3a>${ssrInterpolate(form.description)}</textarea></div><div class="form-group" data-v-680aee3a><label data-v-680aee3a>Иконка</label><div class="icon-section" data-v-680aee3a><button type="button" class="toggle-icons-btn" data-v-680aee3a><div class="selected-icon" data-v-680aee3a>`);
        ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(iconComponent(form.icon)), { size: 20 }, null), _parent);
        _push2(`<span data-v-680aee3a>${ssrInterpolate(form.icon)}</span></div>`);
        _push2(ssrRenderComponent(unref(ChevronDown), {
          size: 16,
        ...
        if (iconsExpanded.value) {
          _push2(`<div class="icons-grid" data-v-680aee3a><!--[-->`);
          ssrRenderList(iconOptions, (icon) => {
            _push2(`<button type="button" class="${ssrRenderClass([{ active: form.icon === icon }, "icon-option"])}" data-v-680aee3a>`);
        ...
        _push2(`</div></div><div class="form-group" data-v-680aee3a><label data-v-680aee3a>Привязанные задачи</label><div class="tasks-section" data-v-680aee3a><button type="button" class="toggle-tasks-btn" data-v-680aee3a><span data-v-680aee3a>Выбрать задачи (${ssrInterpolate(form.taskIds.length)})</span>`);
        _push2(ssrRenderComponent(unref(ChevronDown), {
          size: 16,
        ...
        if (tasksExpanded.value) {
          _push2(`<div class="tasks-list" data-v-680aee3a><!--[-->`);
          ssrRenderList(activeTasks.value, (task) => {
            _push2(`<label class="task-checkbox" data-v-680aee3a><span class="custom-checkbox" data-v-680aee3a><input type="checkbox"${ssrRenderAttr("value", task.id)}${ssrIncludeBooleanAttr(Array.isArray(form.taskIds) ? ssrLooseContain(form.taskIds, task.id) : form.taskIds) ? " checked" : ""} data-v-680aee3a><span class="checkmark" data-v-680aee3a></span></span><span class="task-title" data-v-680aee3a>${ssrInterpolate(task.title)}</span><span class="task-xp" data-v-680aee3a>+${ssrInterpolate(task.xpReward || 50)} XP</span></label>`);
          });
          _push2(`<!--]--></div>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</div></div><div class="form-actions" data-v-680aee3a><button type="button" class="btn-secondary" data-v-680aee3a> Отмена </button><button type="button" class="btn-danger" data-v-680aee3a> Удалить </button><button type="submit" class="btn-primary" data-v-680aee3a>Сохранить</button></div></form></div></div>`);
      }, "body", false, _parent);
    };
  }
});
...
const NodeEditorModal = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-680aee3a"]]);
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        _push2(`<div class="modal-overlay" data-v-4ec2e80c><div class="modal" data-v-4ec2e80c><div class="modal-header" data-v-4ec2e80c><h3 data-v-4ec2e80c>${ssrInterpolate(__props.branch ? "Редактировать ветку" : "Новая ветка")}</h3><button class="close-btn" data-v-4ec2e80c>`);
        _push2(ssrRenderComponent(unref(X), { size: 20 }, null, _parent));
        _push2(`</button></div><form data-v-4ec2e80c><div class="form-group" data-v-4ec2e80c><label data-v-4ec2e80c>Название</label><input${ssrRenderAttr("value", form.name)} type="text" required data-v-4ec2e80c></div><div class="form-group" data-v-4ec2e80c><label data-v-4ec2e80c>Описание</label><textarea placeholder="Опишите направление..." rows="2" data-v-4ec2e80c>${ssrInterpolate(form.description)}</textarea></div><div class="form-group" data-v-4ec2e80c><label data-v-4ec2e80c>Иконка</label><div class="icon-section" data-v-4ec2e80c><button type="button" class="toggle-icons-btn" data-v-4ec2e80c><div class="selected-icon" data-v-4ec2e80c>`);
        ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(iconComponent(form.icon)), { size: 20 }, null), _parent);
        _push2(`<span data-v-4ec2e80c>${ssrInterpolate(form.icon)}</span></div>`);
        _push2(ssrRenderComponent(unref(ChevronDown), {
          size: 16,
          class: { rotated: iconsExpanded.value }
        }, null, _parent));
        _push2(`</button>`);
        if (iconsExpanded.value) {
          _push2(`<div class="icons-grid" data-v-4ec2e80c><!--[-->`);
          ssrRenderList(iconOptions, (icon) => {
            _push2(`<button type="button" class="${ssrRenderClass([{ active: form.icon === icon }, "icon-option"])}" data-v-4ec2e80c>`);
            ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(iconComponent(icon)), { size: 20 }, null), _parent);
            _push2(`</button>`);
          });
          _push2(`<!--]--></div>`);
        ...
        _push2(`</div></div><div class="form-group" data-v-4ec2e80c><label data-v-4ec2e80c>Привязанные задачи (опционально)</label><div class="tasks-section" data-v-4ec2e80c><button type="button" class="toggle-tasks-btn" data-v-4ec2e80c><span data-v-4ec2e80c>Выбрать задачи (${ssrInterpolate(form.taskIds.length)})</span>`);
        _push2(ssrRenderComponent(unref(ChevronDown), {
          size: 16,
          class: { rotated: tasksExpanded.value }
        }, null, _parent));
        _push2(`</button>`);
        if (tasksExpanded.value) {
          _push2(`<div class="tasks-list" data-v-4ec2e80c><!--[-->`);
          ssrRenderList(activeTasks.value, (task) => {
            _push2(`<label class="task-checkbox" data-v-4ec2e80c><span class="custom-checkbox" data-v-4ec2e80c><input type="checkbox"${ssrRenderAttr("value", task.id)}${ssrIncludeBooleanAttr(Array.isArray(form.taskIds) ? ssrLooseContain(form.taskIds, task.id) : form.taskIds) ? " checked" : ""} data-v-4ec2e80c><span class="checkmark" data-v-4ec2e80c></span></span><span class="task-title" data-v-4ec2e80c>${ssrInterpolate(task.title)}</span><span class="task-xp" data-v-4ec2e80c>+${ssrInterpolate(task.xpReward || 50)} XP</span></label>`);
          });
          _push2(`<!--]--></div>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</div></div><div class="form-actions" data-v-4ec2e80c><button type="button" class="btn-secondary" data-v-4ec2e80c> Отмена </button>`);
        if (__props.branch) {
          _push2(`<button type="button" class="btn-danger" data-v-4ec2e80c> Удалить </button>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`<button type="submit" class="btn-primary" data-v-4ec2e80c>${ssrInterpolate(__props.branch ? "Сохранить" : "Создать")}</button></div></form></div></div>`);
      }, "body", false, _parent);
    };
  }
});
...
const BranchModal = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-4ec2e80c"]]);
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "branch-flow-wrapper" }, _attrs))} data-v-5c029dbd>`);
      if (isMobile.value) {
        _push(`<div class="mobile-warning" data-v-5c029dbd>`);
        _push(ssrRenderComponent(unref(AlertTriangle), { size: 32 }, null, _parent));
        _push(`<h3 data-v-5c029dbd>Доступно только на десктопе</h3><p data-v-5c029dbd> Для работы с доской развития используйте компьютер или планшет в горизонтальной ориентации. </p></div>`);
      } else {
            ...
            if (_push2) {
              ...
              _push2(ssrRenderComponent(unref(Panel), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<button title="Сбросить вид" data-v-5c029dbd${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(Maximize), { size: 18 }, null, _parent3, _scopeId2));
                    _push3(`</button><button title="Приблизить" data-v-5c029dbd${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(ZoomIn), { size: 18 }, null, _parent3, _scopeId2));
                    _push3(`</button><button title="Отдалить" data-v-5c029dbd${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(ZoomOut), { size: 18 }, null, _parent3, _scopeId2));
                    _push3(`</button><div class="divider" data-v-5c029dbd${_scopeId2}></div><button title="Авто-расположение" data-v-5c029dbd${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(Layout), { size: 18 }, null, _parent3, _scopeId2));
                    _push3(`</button><button title="Добавить ветку" data-v-5c029dbd${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(Plus), { size: 18 }, null, _parent3, _scopeId2));
                    _push3(`</button>`);
                    if (selectedEdgeId.value) {
                      _push3(`<button title="Удалить связь" data-v-5c029dbd${_scopeId2}>`);
                      _push3(ssrRenderComponent(unref(Unlink), { size: 18 }, null, _parent3, _scopeId2));
                      _push3(`</button>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<button title="Добавить этап" data-v-5c029dbd${_scopeId2}>`);
                    ...
                    if (selectedNodeId.value && isBranchNode(selectedNodeId.value)) {
                      _push3(`<button title="Удалить ветку" data-v-5c029dbd${_scopeId2}>`);
...
const BranchFlow = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-5c029dbd"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(GlassCard, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="task-header" data-v-386fe120${_scopeId}><div class="tags" data-v-386fe120${_scopeId}><!--[-->`);
            ssrRenderList(taskTags.value, (tag) => {
              _push2(`<span class="tag"${ssrRenderAttr("title", tag.name)} data-v-386fe120${_scopeId}>${ssrInterpolate(tag.name)}</span>`);
            });
            _push2(`<!--]--></div><span class="${ssrRenderClass([__props.task.type, "task-type"])}" data-v-386fe120${_scopeId}>${ssrInterpolate(typeLabel.value)}</span></div><h4 data-v-386fe120${_scopeId}>${ssrInterpolate(__props.task.title)}</h4>`);
            if (__props.task.description) {
              _push2(`<p data-v-386fe120${_scopeId}>${ssrInterpolate(__props.task.description)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="task-footer" data-v-386fe120${_scopeId}>`);
            if (__props.task.type !== "HABIT" && __props.task.targetDate) {
              _push2(`<div class="due-date" data-v-386fe120${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Calendar), { size: 14 }, null, _parent2, _scopeId));
              _push2(` ${ssrInterpolate(formattedDate.value)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="actions" data-v-386fe120${_scopeId}><button class="${ssrRenderClass([{ done: __props.task.done }, "complete-btn"])}"${ssrIncludeBooleanAttr(__props.task.type !== "HABIT" && __props.task.done) ? " disabled" : ""} data-v-386fe120${_scopeId}>`);
            ...
            _push2(`</button><button class="delete-btn" data-v-386fe120${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Trash2), { size: 18 }, null, _parent2, _scopeId));
            _push2(`</button><button class="edit-btn" data-v-386fe120${_scopeId}>`);
...
const TaskCard = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-386fe120"]]);
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "task-list" }, _attrs))} data-v-56332760><div class="list-header" data-v-56332760><div class="title-wrapper" data-v-56332760><h3 data-v-56332760>${ssrInterpolate(__props.title)}</h3>`);
      if (__props.taskType !== "HABITS") {
        _push(`<div class="info-badge"${ssrRenderAttr("title", ruleHint.value)} data-v-56332760>`);
        _push(ssrRenderComponent(unref(Info), { size: 14 }, null, _parent));
        _push(`<span class="tooltip" data-v-56332760>${ssrInterpolate(ruleHint.value)}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><button class="add-btn" data-v-56332760>`);
      _push(ssrRenderComponent(unref(Plus), { size: 20 }, null, _parent));
      _push(`</button></div><div class="tasks" data-v-56332760><!--[-->`);
      ...
      if (tasks.value.length === 0) {
        _push(`<p class="empty" data-v-56332760>${ssrInterpolate(emptyMessage.value)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const TaskList = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-56332760"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(GlassCard, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h4 data-v-8474a28c${_scopeId}>${ssrInterpolate(__props.reward.title)}</h4>`);
            if (__props.reward.description) {
              _push2(`<p data-v-8474a28c${_scopeId}>${ssrInterpolate(__props.reward.description)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="price" data-v-8474a28c${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Coins), { size: 16 }, null, _parent2, _scopeId));
            _push2(` ${ssrInterpolate(__props.reward.price)}</div><button class="buy-btn"${ssrIncludeBooleanAttr(__props.reward.purchased || unref(userStore).coins < __props.reward.price) ? " disabled" : ""} data-v-8474a28c${_scopeId}>${ssrInterpolate(__props.reward.purchased ? "Куплено" : "Купить")}</button>`);
          } else {
            return [
...
const RewardCard = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-8474a28c"]]);
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const rewardsStore = useRewardsStore();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "reward-list" }, _attrs))} data-v-f164f98e><div class="list-header" data-v-f164f98e><h3 data-v-f164f98e>Магазин наград</h3></div><div class="rewards-grid" data-v-f164f98e><!--[-->`);
...
const RewardList = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-f164f98e"]]);
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "overall-progress" }, _attrs))} data-v-c10f9e25><h4 data-v-c10f9e25>Общий прогресс XP</h4>`);
...
const OverallProgress = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-c10f9e25"]]);
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "health-indicator" }, _attrs))} data-v-64c96400><h4 data-v-64c96400>Здоровье</h4>`);
...
const HealthIndicator = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-64c96400"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "settings-page" }, _attrs))} data-v-5717e348><div class="settings-grid" data-v-5717e348>`);
      _push(ssrRenderComponent(GlassCard, { class: "settings-card" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-5717e348${_scopeId}>Внешний вид</h3><div class="setting-item" data-v-5717e348${_scopeId}><div class="setting-info" data-v-5717e348${_scopeId}><span class="label" data-v-5717e348${_scopeId}>Тема</span><span class="desc" data-v-5717e348${_scopeId}>Светлая или тёмная</span></div><div class="theme-toggle" data-v-5717e348${_scopeId}><button class="${ssrRenderClass([{ active: unref(settingsStore).theme === "dark" }, "theme-option"])}" data-v-5717e348${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Moon), { size: 18 }, null, _parent2, _scopeId));
            _push2(`</button><button class="${ssrRenderClass([{ active: unref(settingsStore).theme === "light" }, "theme-option"])}" data-v-5717e348${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Sun), { size: 18 }, null, _parent2, _scopeId));
            _push2(`</button></div></div><div class="setting-item" data-v-5717e348${_scopeId}><div class="setting-info" data-v-5717e348${_scopeId}><span class="label" data-v-5717e348${_scopeId}>Акцентный цвет</span><span class="desc" data-v-5717e348${_scopeId}>Выберите оттенок</span></div><div class="color-options" data-v-5717e348${_scopeId}><!--[-->`);
            ssrRenderList(unref(ACCENT_COLORS), (color) => {
              _push2(`<button style="${ssrRenderStyle({ backgroundColor: color.value })}" class="${ssrRenderClass([{ active: unref(settingsStore).accentColor === color.value }, "color-dot"])}"${ssrRenderAttr("title", color.name)} data-v-5717e348${_scopeId}></button>`);
            });
            _push2(`<!--]--></div></div><div class="setting-item" data-v-5717e348${_scopeId}><div class="setting-info" data-v-5717e348${_scopeId}><span class="label" data-v-5717e348${_scopeId}>Анимации</span><span class="desc" data-v-5717e348${_scopeId}>Плавные переходы</span></div><label class="switch" data-v-5717e348${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(settingsStore).animationsEnabled) ? ssrLooseContain(unref(settingsStore).animationsEnabled, null) : unref(settingsStore).animationsEnabled) ? " checked" : ""} data-v-5717e348${_scopeId}><span class="slider" data-v-5717e348${_scopeId}></span></label></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(GlassCard, { class: "settings-card" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-5717e348${_scopeId}>Уведомления</h3><div class="setting-item" data-v-5717e348${_scopeId}><div class="setting-info" data-v-5717e348${_scopeId}><span class="label" data-v-5717e348${_scopeId}>Звук</span><span class="desc" data-v-5717e348${_scopeId}>Короткий сигнал</span></div><label class="switch" data-v-5717e348${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(settingsStore).soundEnabled) ? ssrLooseContain(unref(settingsStore).soundEnabled, null) : unref(settingsStore).soundEnabled) ? " checked" : ""} data-v-5717e348${_scopeId}><span class="slider" data-v-5717e348${_scopeId}></span></label></div><div class="setting-item" data-v-5717e348${_scopeId}><div class="setting-info" data-v-5717e348${_scopeId}><span class="label" data-v-5717e348${_scopeId}>Всплывающие сообщения</span><span class="desc" data-v-5717e348${_scopeId}>Показывать тосты</span></div><label class="switch" data-v-5717e348${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(settingsStore).notificationsEnabled) ? ssrLooseContain(unref(settingsStore).notificationsEnabled, null) : unref(settingsStore).notificationsEnabled) ? " checked" : ""} data-v-5717e348${_scopeId}><span class="slider" data-v-5717e348${_scopeId}></span></label></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(GlassCard, { class: "settings-card" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 data-v-5717e348${_scopeId}>Данные</h3><div class="setting-item" data-v-5717e348${_scopeId}><div class="setting-info" data-v-5717e348${_scopeId}><span class="label" data-v-5717e348${_scopeId}>Авто-бэкап при выходе</span><span class="desc" data-v-5717e348${_scopeId}>Сохранять копию</span></div><label class="switch" data-v-5717e348${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(settingsStore).autoBackup) ? ssrLooseContain(unref(settingsStore).autoBackup, null) : unref(settingsStore).autoBackup) ? " checked" : ""} data-v-5717e348${_scopeId}><span class="slider" data-v-5717e348${_scopeId}></span></label></div>`);
            if (unref(settingsStore).lastBackupDate) {
              _push2(`<div class="backup-info" data-v-5717e348${_scopeId}> Последний: ${ssrInterpolate(new Date(unref(settingsStore).lastBackupDate).toLocaleString())}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="action-group" data-v-5717e348${_scopeId}><button class="action-btn" data-v-5717e348${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Download), { size: 16 }, null, _parent2, _scopeId));
            _push2(` Бэкап </button><button class="action-btn" data-v-5717e348${_scopeId}>`);
            _push2(ssrRenderComponent(unref(FileJson), { size: 16 }, null, _parent2, _scopeId));
            _push2(` Экспорт </button><button class="action-btn" data-v-5717e348${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Upload), { size: 16 }, null, _parent2, _scopeId));
            _push2(` Импорт </button><button class="action-btn" data-v-5717e348${_scopeId}>`);
            _push2(ssrRenderComponent(unref(RotateCcw), { size: 16 }, null, _parent2, _scopeId));
            _push2(` Восстановить </button><button class="action-btn danger" data-v-5717e348${_scopeId}>`);
...
const SettingsPanel = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-5717e348"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "dashboard" }, _attrs))} data-v-976a2826>`);
      if (unref(uiStore).activeNav !== "board") {
        _push(`<section class="dashboard-section stats" data-v-976a2826>`);
        _push(ssrRenderComponent(StatsOverview, null, null, _parent));
        _push(`</section>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<section class="dashboard-section content-section" data-v-976a2826>`);
      if (unref(uiStore).activeNav === "board") {
      ...
      if (unref(uiStore).activeNav === "tasks") {
        _push(`<div class="tasks-dashboard" data-v-976a2826>`);
        _push(ssrRenderComponent(TaskList, {
          "task-type": "HABITS",
          title: "Привычки",
          "default-type": "HABIT"
        }, null, _parent));
        _push(`<div class="horizons-grid" data-v-976a2826>`);
        _push(ssrRenderComponent(TaskList, {
          "task-type": "TASK_DAY",
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-976a2826"]]);
export {
  index as default
};
//# sourceMappingURL=index-DXqNlm2b.js.map
